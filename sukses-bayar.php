    ...
    <div class="container h-100">
        <div class="row mb-5 d-flex align-items-center">
            <div class="col-12 col-xl-6 px-3 px-xl-0">
                ...
                <h3 class="fw-600 mt-5 pt-5">Terimakasih telah membeli merchandise kami</h3>
                <p class="fz-14 my-4">Pesanan akan segera kami cek dan barang pun akan segera kami kirimkan kepada
                    alamat
                    yang tertera</p>
                <a href="index.php#merchan" class="btn btn-danger w-100">Kembali</a>
            </div>
            <div
