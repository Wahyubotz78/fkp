...
<body>
    ...
    <div class="container mt-5 pt-5 position-relative text-center text-md-start">
        <img src="assets/img/decorHero.svg" class="decorHero position-absolute top-50 d-none d-md-block" alt="">
        <div class="row mt-5 pt-5 d-flex justify-content-center justify-content-md-between gap-4 flex-wrap">
            ...
            <div class="col-12 col-md-7 d-flex">
                <img src="assets/img/imgHero2.svg" alt="Hero Image" class="imgHero img-fluid">
                <!-- <a href="#history" class="arrow down">
                    <i class="bi bi-arrow-down"></i>
                    <span>scroll</span>
                </a> -->
                <a href="#history" class="d-flex align-items-center text-dark d-none d-md-flex">
        ...
        <div class="container">
            ...
            <div class="row mt-5 pt-5">
                ...
                <div class="col-md-3">
                    ...
                    <p class="fz-14 text-center">Pertama lali membentuk Pengurus Daeah FKP beberapa Kota dan Kabupaten di Indonesia</p>
                </div>
                <div class="col-md-3">
                    <h3 class="fw-600 text-center">2014</h3>
                    <p class="fz-14 text-center">Melakukan kegiatan bisnis bertaraf ernasional dan membawa produk - produk milik anggota FKP</p>
                </div>
                ...
                <div class="">
                    <img src="assets/img/imgHistoryLeft.svg" class="imgHistoryLeft position-absolute bottom-cus start-0" alt="">
                    <img src="assets/img/imgHistoryRight.svg" class="imgHistoryRight position-absolute bottom-cus end-0 d-none d-md-block" alt="">
                </div>

                <div class="col-md-3">
                    <h3 class="fw-600 text-center">2016</h3>
                    <p class="fz-14 text-center">Menyelenggarakan Silaturahmi Pengusaha Muda Nasional dalam kegiatan Gaya Muda 2016</p>
                </div>
                <div class="col-md-3">
                    <h3 class="fw-600 text-center">2017</h3>
                    <p class="fz-14 text-center">Melakukan pemilihan ketua pertama kali dengan dukungan DPW dari setiap provinsi di indonesia</p>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <p class="fz-14 text-center">telah memiliki anggota aktif di setiap provinsi, kota dan kabupaten ± sekitar 12.000 anggota aktif berwirausaha</p>
                </div>
    ...
    <section id="organization" class="mx-auto text-center position-relative">
        <div class="container">
            <img src="assets/img/decorOrganization.svg" class="position-absolute decorOrganization  d-none d-md-block" alt="">
            ...
            <p class="mx-auto descOrganization">Menjadi organisasi terdepan dalam mengembangkan semangat kewirausahawaan di kalangan pemuda</p>
            ...
            <div class="row d-flex justify-content-between mx-auto">
                <div class="col-md-3 bg-1">
                    <p class="fz-14 mt-5 pt-5">Menjadi wadah dalam peningkatan kewirausahaan pemuda baik anggota maupun masyarakat melalui program kerja organisasi</p>
                    <img src="assets/img/garisHistory.svg" alt="">
                </div>
                <div class="col-md-3 bg-2">
                    <p class="fz-14 mt-5 pt-5">Menjadi organisasi yang berperan aktif dan ikut serta dalam program kewirausahaan di internal maupun eksternal</p>
                    <img src="assets/img/garisHistory.svg" alt="">
                </div>


                <div class="col-md-3 bg-3">
                    <p class="fz-14 mt-5 pt-5">Menjalin komunkasi dan hubungan dengan para mitra strategis dalam peningkatan kerjasama positif untuk kemajuan organisasi</p>
                    <img src="assets/img/garisHistory.svg" alt="">
                </div>
            </div>
        </div>
    ...
    <section class="mt-md-5 container">
        <div class="row mt-md-5 pt-md-5 d-flex justify-content-between gap-4">
            ...
            <div class="col-12 col-md-6 d-flex">
                <img src="assets/img/imgOrganization2.svg" alt="Hero Image" class="imgOrganization img-fluid me-5">
    ...
    <section id="structure" class="container mx-auto position-relative">
        ...
        <div class="row d-flex justify-content-center text-center">
            <div class="col-10">
                <p class="text-center mt-5">Komitmen kami dalam menjalankan fungsi organisasi yang baik, maka kami membentuk kepengurusan yang kuat dan berkompeten sebagai berikut</p>
                <img src="assets/img/garisHistory.svg" alt="">
            </div>
        </div>
        <div class="row mt-4">
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapse1" class="accordion-collapse collapse" aria-labelledby="flush-heading1" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">Mikail Rakhimi - Ketua Umum</div>
                        </div>
                    </div>
                    <div class="accordion-item">
            ...
            <div class="col-md-4 mb-3">
                <div class="accordion accordion-flush" id="accordionFlushExample3">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapse13" class="accordion-collapse collapse" aria-labelledby="flush-heading13" data-bs-parent="#accordionFlushExample3">
                            <div class="accordion-body">Mikail Rakhimi - Ketua Umum</div>
                        </div>
                    </div>
                </div>
    ...
    <section id="program" class="mx-auto position-relative">
        <div class="container">
            <img src="assets/img/imgProgramLeft.svg" class="position-absolute top-25 start-0" alt="">
            <img src="assets/img/imgProgramRight.svg" class="position-absolute top-50 end-0" alt="">
            <img src="assets/img/decorOrganization.svg" class="position-absolute decorPrograms d-none d-md-block" alt="">
            ...
            <div class="row mt-5 pt-5 gap-1 d-flex justify-content-center">
                <div class="col-md-3 position-relative mb-5 pb-5">
                    <div class="bg-blue-young px-4 pt-5 pb-3">
                        <img src="assets/img/garisProgram.svg" alt="" class="position-absolute top-cus start-cus w-100" />
                        <p class="fw-600"><img src="assets/img/garisSmallProgram.svg" alt="">&nbsp; First Program</p>
                        <h5 class="fw-700 mt-4 mb-4">Inkubator Bisnis</h5>
                        <p class="fz-14">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet l</p>
                        <div class="mt-4">
                ...
                <div class="col-md-6">
                    <div class="row mb-4 d-flex align-items-center">
                        <div class="col-12 col-md-4">
                            <img src="assets/img/newsList1.svg" alt="">
                        </div>
            ...
            <div class="row mt-5 pt-3">
                <div class="col-md-6">
                    ...
                    <div class="d-flex my-4">
                        ...
                        <span class="fz-14">Komplek Departemen Keuangan C70, Kembangan Jakarta Barat, Indonesia 11610</span>
                    </div>
                    <div class="mt-5  text-center text-md-start">
                        <p class="fz-14 fw-600">Social Media</p>
                        <img src="assets/img/fbContact.svg" alt="">
                        <img src="assets/img/ytContact.svg" alt="">
                        <img src="assets/img/igContact.svg" alt="">
                    </div>
                </div>
                <div class="col-md-6 mt-5">
                    <form class="fz-14">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control bg-abu" id="text" placeholder="Name">
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Your Email</label>
                            <input type="email" class="form-control bg-abu" id="email" placeholder="Email">
                        </div>
                        <div class="mb-3 form-floating">
                            <textarea class="form-control bg-abu" placeholder="Messages" id="floatingTextarea"></textarea>
    ...
    <div class="position-relative d-flex flex-column align-items-center mt-5">
        <img src="assets/img/imgContact.svg" alt="" class="w-100 h-100 img-fluid imgActivies">
        <a href="admin/regis.php" class="btn btn-danger fs-6 mt-md-3 position-absolute btn-activies">Gabung Sekarang</a>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 fz-14">
                <ul class="ps-0" style="list-style: none; line-height: 40px">
                    ...
                    <li>
                        <img src="assets/img/fbFooter.svg" class="me-3" alt="">
                        <img src="assets/img/ytFooter.svg" class="me-3" alt="">
                        <img src="assets/img/igFooter.svg" class="me-3" alt="">
                    </li>
                </ul>
            </div>
        </div>
