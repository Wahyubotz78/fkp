        ...
        <div class="row mb-5">
            <div class="col-12 col-xl-6 px-3 px-xl-0">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <p class="fz-14 fw-600 text-end">Mochamad Naufal</p>
                    </div>
                    <div class="col-6">
                        <p class="fz-14">No. Telp.</p>
                    </div>
                    <div class="col-6">
                        <p class="fz-14 fw-600 text-end">082919282919</p>
                    </div>
                    <div class="col-6">
                        <p class="fz-14">Alamat</p>
                    </div>
                    <div class="col-6">
                        <p class="fz-14 fw-600 text-end">Jalan Noenoeng Tisnasaputra 10 46133 Tasikmalaya Jawa Barat
                        </p>
                    </div>
                </div>
                <hr class="w-100">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <p class="fz-14 fw-600 text-end">XL</p>
                    </div>
                    <div class="col-6">
                        <p class="fz-14">Jumlah Barang</p>
                    </div>
                    <div class="col-6">
                        <p class="fz-14 fw-600 text-end">x1</p>
                    </div>
                    <div class="col-6">
